...
var Team = /** @class */ (function () {
    ...
    Team.prototype.calculateRun = function (but_id) {
    ...
    Team.prototype.calcplayerscore = function (but_id) {
    ...
    Team.prototype.Enable_button = function (id) {
        document.getElementById(id).disabled = false;
    };
    Team.prototype.Disable_button = function (id) {
